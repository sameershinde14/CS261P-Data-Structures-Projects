...
import RBTTestCases.rbttc09;

public class splaytc09 {
	private static final Logger LOGGER = Logger.getLogger(splaytc09.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			init("./Logs/SplayTree/splaytc09.log");
